...
public class EmailService {
    ...
    public void sendVolunteerFormFilledUpEmail(String toEmail, String volunteerName) {
        try {
            MimeMessage message = mailSender.createMimeMessage();
            MimeMessageHelper helper = new MimeMessageHelper(message, true);

            helper.setTo(toEmail);
            helper.setSubject("Your Volunteering Form Has Been Submitted");
            helper.setText(
                    "<div style='font-family: Arial, sans-serif; padding: 10px;'>" +
                            "<h2>Hello " + volunteerName + ",</h2>" +
                            "<p>Thank you for submitting your volunteering form! Your request has been received and is currently pending manager verification.</p>"
                            +
                            "<p>Once your request is verified, you will receive an email with further instructions.</p>"
                            +
                            "<br>" +
                            "<p>Best Regards,</p>" +
                            "<p><strong>ReqSync Team</strong></p>" +
